...
- редактировать проекты и перечень их функциональностей;
- удалять проекты вместе с их функциональностями;
...
- `PUT /api/projects/{project_id}` - обновление проекта и полного перечня его функциональностей;
- `DELETE /api/projects/{project_id}` - удаление проекта вместе с функциональностями;
